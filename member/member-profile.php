...
<html lang="en">
    ...
    <body class="app sidebar-mini">
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                <li><a class="app-menu__item" href="member-home-book.php"><i class="app-menu__icon fa fa-book"></i><span class="app-menu__label">Books</span></a></li>
                <li><a class="app-menu__item" href="#"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">My Profile</span></a></li>
              ...
              <div class="col-md-12">
                <div class="profile">
                  <div class="info"><i class="user-img fa fa-user-circle-o fa-5x"></i>
                    <h4><?php echo $_SESSION["m_name"]; ?></h4>
                  </div>
                    ...
                    ?>
                      <form>
                        ...
                        <div class="row mb-4">
                          ...
                          <div class="col-md-4">
                            <label><?php echo $row['m_mail'];  ?></label>
                          </div>
                        </div>
                        <div class="row mb-4">
                          <div class="col-md-4">
                          ...
                          <div class="col-md-4">
                            <label><?php echo $row['m_address'];  ?></label>
                          </div>
                        </div>
                        <div class="row mb-4">
                          <div class="col-md-4">
                          ...
                          <div class="col-md-4">
                            <label><?php echo $row['m_mno'];  ?></label>
                          </div>
                        </div>
                      </form>
                      <?php 
                  ...
                  <div class="tab-pane fade" id="user-settings">
                    <div class="tile user-settings">
                      ...
                      <?php
                        ...
                        $mid1= $_SESSION['m_id'];
                        $sql1 = "select * from member where m_id= {$mid1}";
                      ...
                      <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                        <div class="row">
                          <div class="col-md-8 mb-4">
                            <label>Name</label>
                            <input class="form-control" type="hidden" name="mid" value="<?php echo $row1['m_id'];  ?>">
                            <input class="form-control" type="text" name="mname" value="<?php echo $row1['m_name'];  ?>">
                          </div>
                          <div class="clearfix"></div>
                          <div class="col-md-8 mb-4">
                            <label>Email</label>
                            <input class="form-control" type="text" name="email" value="<?php echo $row1['m_mail'];  ?>">
                          </div>
                          <div class="clearfix"></div>
                          <div class="col-md-8 mb-4">
                            <label>Address</label>
                            <textarea class="form-control" name="address" rows="4" ><?php echo $row1['m_address'];  ?></textarea>
                          </div>
                          <div class="clearfix"></div>
                          <div class="col-md-8 mb-4">
                            <label>Mobile No</label>
                            <input class="form-control" name="mno" type="text" value="<?php echo $row1['m_mno'];  ?>">
                          </div>
                        </div>
                        <div class="row mb-10">
                          <div class="col-md-12">
                      ...
                      <?php
                          ...
                          if(isset($_POST['register'])){
                            ...
                            {
                              $sql= "update member set m_name='{$name}', m_mail='{$email}', m_address='{$address}',m_mno={$mno} where m_id={$mid2}";
