...
<html lang="en">
    <head>
        ...
        <title>Member-Return-Book</title>
        <meta charset="utf-8">
    ...
    <body class="app sidebar-mini">
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li><a class="app-menu__item" href="#"><i class="app-menu__icon fa fa-reply"></i><span class="app-menu__label">Return Book</span></a></li>
        ...
        <main class="app-content">
            <div class="app-title">
                <div>
                  <h1><i class="fa fa-exchange"></i> Return Book</h1>
                </div>
              ...
              <div class="tile">
                <div class="tile-body">
                  ...
                  <?php
                      ...
                      $mid= $_SESSION["m_id"];
                      $sql = "select * from issued_book where m_id={$mid} and r_status=0";
                    ...
                    <table class="table table-hover table-bordered" id="sampleTable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          if( $diff->format("%R") == "-"){
                          ?>
                          <td><a style="color: #fff; background-color: rgb(10, 240, 48); text-decoration: none; padding: 3px 7px;" href="return-book.php?id=<?php echo $row['i_id']; ?>">RETURN</a></td>
                          <?php } else{ ?>
                          <td><a style="color: #fff; background-color: #e74c3c; text-decoration: none; padding: 3px 7px;" href="fine-return-book.php?id=<?php echo $row['i_id']; ?>">PAY FINE & RETURNED</a></td>
                          <?php } ?>
                        </tr>
                        <?php } ?>
                      </tbody>
