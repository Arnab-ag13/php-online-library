    ...
    <body class="app sidebar-mini">
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li><a class="app-menu__item" href="#"><i class="app-menu__icon fa fa-money"></i><span class="app-menu__label">Fine History</span></a></li>
            </ul>    
        </aside>
        <main class="app-content">
            <div class="app-title">
                <div>
                  <h1><i class="fa fa-exchange"></i> Fine History</h1>
                </div>
                <ul class="app-breadcrumb breadcrumb">
                  <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                  <li class="breadcrumb-item"><a href="#">Fine History</a></li>
                </ul>
            </div>
            <div class="row">
            <div class="col-md-12">
              <div class="tile">
                <div class="tile-body">
                  ...
                  <?php
                      ...
                      $mid= $_SESSION["m_id"];
                      $sql = "select * from fine_details join issued_book on fine_details.i_id=issued_book.i_id where issued_book.m_id={$mid}";
                    ...
                    <table class="table table-hover table-bordered" id="sampleTable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $row['o_r_date']; ?></td>
                          <?php
                          if( $row['pay_status'] == 1){
                          ?>
                          <td><label style="color: #fff; background-color: #0cee44; text-decoration: none; padding: 3px 7px;" href="#">PAIED</label></td>
                          <?php } else{ ?>
                          <td><label style="color: #fff; background-color: #e74c3c; text-decoration: none; padding: 3px 7px;" href="#">NOT PAIED</label></td>
                          <?php } ?>
                        </tr>
                        <?php } ?>
                      </tbody>
                    </table>
                    <?php }else echo "<center><h2>No History found</h2></center>"; ?>
                  </div>
                </div>
              </div>      
            </div>
