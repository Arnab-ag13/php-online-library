...
<html lang="en">
    <head>
        ...
        <title>Member-Issued-Book</title>
        <meta charset="utf-8">
    ...
    <body class="app sidebar-mini">
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li><a class="app-menu__item" href="#"><i class="app-menu__icon fa fa-exchange"></i><span class="app-menu__label">Issued Books History</span></a></li>
        ...
        <main class="app-content">
            <div class="app-title">
                <div>
                  <h1><i class="fa fa-exchange"></i> Issued Books History</h1>
                </div>
                <ul class="app-breadcrumb breadcrumb">
                  <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                  <li class="breadcrumb-item"><a href="#">Issued Books History</a></li>
                </ul>
            </div>
            <div class="row">
            <div class="col-md-12">
              <div class="tile">
                <div class="tile-body">
                  ...
                  <?php
                      ...
                      $mid= $_SESSION["m_id"];
                      $sql = "select * from issued_book where m_id={$mid}";
                    ...
                    <table class="table table-hover table-bordered" id="sampleTable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          if( $row['r_status'] == 1){
                          ?>
                          <td><label style="color: #fff; background-color: rgb(10, 240, 48); text-decoration: none; padding: 3px 7px;" href="#">RETURNED</label></td>
                          <?php } else{ ?>
                          <td><label style="color: #fff; background-color: #e74c3c; text-decoration: none; padding: 3px 7px;" href="#">NOT RETURNED</label></td>
                          <?php } ?>
                        </tr>
                        <?php } ?>
                      </tbody>
