...
<html lang="en">
    ...
    <body class="app sidebar-mini">
        ...
        <main class="app-content">
            <div class="app-title">
                <div>
                  <h1><i class="fa fa-user"></i> Update Admin</h1>
                </div>
              ...
              <div class="tile">
                <div class="tile-body">
                  ...
                  <?php
                    ...
                    ?>
                  <form class="form-horizontal" style="padding: 10px 150px 20px 150px;" action="update-admin1.php" method="POST">
                <center><h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>Update Admin</h3></center><br><br>
                <div class="form-group row">
                  <label class="control-label col-md-3">Name</label>
                  <div class="col-md-8">
                    <input class="form-control" name="aid" type="hidden" value="<?php echo $row['a_id'];  ?>">
                    <input class="form-control" name="mname" type="text" placeholder="Enter full name" value="<?php echo $row['a_name'];  ?>">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">Email</label>
                  <div class="col-md-8">
                    <input class="form-control col-md-8" name="email" type="email" placeholder="Enter email address" value="<?php echo $row['a_mail'];  ?>">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">Address</label>
                  <div class="col-md-8">
                    <textarea class="form-control" name="address" rows="4" placeholder="Enter your address" ><?php echo $row['a_address']; ?></textarea>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">Mobile No.</label>
                  <div class="col-md-9">
                    <input class="form-control col-md-8" name="mobile" type="text" placeholder="Enter mobile no." value= "<?php echo $row['a_mno']; ?>"  >
                  </div>
                </div>
                <div class="form-group row">
