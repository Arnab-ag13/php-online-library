        ...
        <main class="app-content">
            ...
            <div class="col-md-12">
              <div class="tile">
                ...
                <center><h3 class="login-head"><i class="fa fa-lg fa-fw fa-book"></i>Add Book</h3></center><br><br>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control col-md-8" name="author" type="text" placeholder="Enter Author Name">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">Quantity</label>
                  <div class="col-md-9">
                    <input class="form-control col-md-8" name="qty" type="number" placeholder="Enter Total Quantity"><br>
                  </div>
                </div>
                <div class="form-group row">
              ...
              if($auth==""){
                echo '<script>alert("***author field cannot be blank")</script>';
              }
              else if(!preg_match("/^[A-Za-z\s]+$/",$auth)){
                echo '<script>alert("**Author name should be string of letters.. Numbers & other charechters not allowed")</script>';
              }
              if($qty=="" || $qty== 0){
                echo '<script>alert("***Quantity field cannot be blank or 0")</script>';
              }
              else
              {
              $sql= "insert into book(b_name,b_author,t_qty,avl_qty) values('{$name}','{$auth}',{$qty},{$qty})";
              $result= mysqli_query($conn,$sql) or die("query failed");

                //header("Location: http://localhost/My Project/member/member-login.php");

                echo '<script>alert("Book added successfull.");
