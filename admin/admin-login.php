      ...
      <div class="login-box" style="height: 400px">
        <form class="login-form" action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
          ...
          <div class="form-group btn-container">
           ...
           <p class="label-text" style="font-size: 16px; text-align: center;"> Back to &nbsp;<a href="../index.php">Home</a></p>
        </form>
        <?php
            ...
            if(isset($_POST['login'])){
              ...
              $sql= "select * from admin where a_mail = '{$username}' and a_psw = '{$password}'";
              ...
              if(mysqli_num_rows($result) > 0){
                ...
                header("Location: http://localhost/My Project/admin/admin-home.php");
