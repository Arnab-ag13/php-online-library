...
<html lang="en">
    ...
    <body class="app sidebar-mini">
        ...
        <main class="app-content">
            <div class="app-title">
                <div>
                  <h1><i class="fa fa-book"></i> Update Book</h1>
                </div>
                <ul class="app-breadcrumb breadcrumb">
                  <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                  <li class="breadcrumb-item"><a href="#">Update Book</a></li>
                </ul>
            </div>
            <div class="row">
            <div class="col-md-12">
              <div class="tile">
                <div class="tile-body">
                  ...
                  <?php
                    ...
                    ?>
                  <form class="form-horizontal" style="padding: 10px 150px 20px 150px;" action="update-book1.php" method="POST">
                <center><h3 class="login-head"><i class="fa fa-lg fa-fw fa-book"></i>Update Book</h3></center><br><br>
                <div class="form-group row">
                  <label class="control-label col-md-3">Book Name</label>
                  <div class="col-md-8">
                  <input class="form-control" name="bid" type="hidden"  value="<?php echo $row['b_id'];  ?>">
                    <input class="form-control" name="bname" type="text" placeholder="Enter Book Name" value="<?php echo $row['b_name'];  ?>">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">Author Name</label>
                  <div class="col-md-8">
                    <input class="form-control col-md-8" name="auth" type="text" placeholder="Enter Author Name" value="<?php echo $row['b_author'];  ?>">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">Total Quantity</label>
                  <div class="col-md-9">
                    <input class="form-control col-md-8" name="tqty" type="number" placeholder="Enter Total Quantity" value="<?php echo $row['t_qty'];  ?>"><br>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">Available Quantity</label>
                  <div class="col-md-9">
                    <input class="form-control col-md-8" name="aqty" type="number" placeholder="Enter Available Quantity" value="<?php echo $row['avl_qty'];  ?>"><br>
                  </div>
                </div>
                <div class="form-group row">
