...
<html lang="en">
    ...
    <body class="app sidebar-mini">
        ...
        <main class="app-content">
            <div class="app-title">
                <div>
                  <h1><i class="fa fa-user"></i> Add Member</h1>
                </div>
            ...
            <div class="col-md-12">
              <div class="tile">
                ...
                <center><h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>Add Member</h3></center><br><br>
              ...
              $result= mysqli_query($conn,$sql) or die("query failed");
                ...
                echo '<script>alert("Member added successfull.");
