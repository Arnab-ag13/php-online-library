    ...
    <body class="app sidebar-mini">
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li><a class="app-menu__item" href="#"><i class="app-menu__icon fa fa-money"></i><span class="app-menu__label">Fine Details</span></a></li>
            </ul>    
        </aside>
        <main class="app-content">
            <div class="app-title">
                <div>
                  <h1><i class="fa fa-money"></i> Fine Details</h1>
                </div>
                <ul class="app-breadcrumb breadcrumb">
                  <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                  <li class="breadcrumb-item"><a href="#">Fine Details</a></li>
                </ul>
            </div>
            <div class="row">
            <div class="col-md-12">
                ...
                <div class="tile-body">
                  <div class="table-responsive">
                    <?php
                      ...
                      $sql = "select * from fine_details join issued_book on fine_details.i_id=issued_book.i_id";
