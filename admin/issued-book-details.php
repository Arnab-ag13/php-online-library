    ...
    <body class="app sidebar-mini">
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li><a class="app-menu__item" href="#"><i class="app-menu__icon fa fa-exchange"></i><span class="app-menu__label">Issued Books</span></a></li>
        ...
        <main class="app-content">
            <div class="app-title">
                <div>
                  <h1><i class="fa fa-exchange"></i> Issued Book Details</h1>
                </div>
                <ul class="app-breadcrumb breadcrumb">
                  <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                  <li class="breadcrumb-item"><a href="#">Issued Books</a></li>
                </ul>
            </div>
            <div class="row">
            <div class="col-md-12">
                    ...
                    <table class="table table-hover table-bordered" id="sampleTable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          if( $row['r_status'] == 1){
                          ?>
                          <td><label style="color: #fff; background-color: #0cee44; text-decoration: none; padding: 3px 7px;" href="#">RETURNED</label></td>
                          <?php } else{ ?>
