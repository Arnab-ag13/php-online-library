...
<html lang="en">
    ...
    <body class="app sidebar-mini">
        ...
        <main class="app-content">
            ...
            <div class="row">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a style="color: #fff; background-color: #0cee44; text-decoration: none; padding: 5px 10px;" href="#"><i class="fa fa-plus-circle" aria-hidden="true"></i><b>ADD NEW</b></a><br>  
            <div class="col-md-12">
              <div class="tile">
                <div class="tile-body">
                    ...
                    <table class="table table-hover table-bordered" id="sampleTable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a style="color: #fff; background-color: #e67e22; text-decoration: none; padding: 3px 7px;" href="update-book.php?id= <?php echo $row['b_id']  ?>">EDIT</a></td>
                          <td><a style="color: #fff; background-color: #e74c3c; text-decoration: none; padding: 3px 7px;" href="delete-book.php?id= <?php echo $row['b_id']  ?>">DELETE</a></td>
                        </tr>
                        <?php } ?>
                      </tbody>
                    </table>
