...
<html lang="en">
    ...
    <body class="app sidebar-mini">
            ...
            <ul class="app-menu">
                ...
                <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-users"></i><span class="app-menu__label">User Details</span><i class="treeview-indicator fa fa-angle-right"></i></a>
                    <ul class="treeview-menu">
                      ...
                      <li><a class="treeview-item" href="#"><i class="icon fa fa-circle-o"></i> Member</a></li>
                    </ul>
                </li>
        ...
        <main class="app-content">
            <div class="app-title">
                <div>
                  <h1><i class="fa fa-users"></i> Member Details</h1>
                </div>
            ...
            <div class="row">
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a style="color: #fff; background-color: #0cee44; text-decoration: none; padding: 5px 10px;" href="add-member.php"><i class="fa fa-plus-circle" aria-hidden="true"></i><b>ADD NEW</b></a><br>
            <div class="col-md-12">
              <div class="tile">
                <div class="tile-body">
                    ...
                    <table class="table table-hover table-bordered" id="sampleTable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $row['m_mno']; ?></td>
                          <td><a style="color: #fff; background-color: #e67e22; text-decoration: none; padding: 3px 7px;" href="update-member.php?id=<?php echo $row['m_id']; ?>">EDIT</a></td>
                          <td><a style="color: #fff; background-color: #e74c3c; text-decoration: none; padding: 3px 7px;" href="delete-member.php?id=<?php echo $row['m_id']; ?>">DELETE</a></td>
                        </tr>
                        <?php } ?>
                      </tbody>
                    </table>
